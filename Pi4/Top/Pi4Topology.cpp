// ======================================================================
// \title  Pi4Topology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <Pi4/Top/Pi4TopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <Pi4/Top/Pi4PacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::Pi4_blockDrv::WARN, PingEntries::Pi4_blockDrv::FATAL, "blockDrv"},
    {PingEntries::Pi4_tlmSend::WARN, PingEntries::Pi4_tlmSend::FATAL, "chanTlm"},
    {PingEntries::Pi4_cmdDisp::WARN, PingEntries::Pi4_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::Pi4_cmdSeq::WARN, PingEntries::Pi4_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::Pi4_eventLogger::WARN, PingEntries::Pi4_eventLogger::FATAL, "eventLogger"},
    {PingEntries::Pi4_fileDownlink::WARN, PingEntries::Pi4_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::Pi4_fileManager::WARN, PingEntries::Pi4_fileManager::FATAL, "fileManager"},
    {PingEntries::Pi4_fileUplink::WARN, PingEntries::Pi4_fileUplink::FATAL, "fileUplink"},
    {PingEntries::Pi4_prmDb::WARN, PingEntries::Pi4_prmDb::FATAL, "prmDb"},
    {PingEntries::Pi4_rateGroup1::WARN, PingEntries::Pi4_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::Pi4_rateGroup2::WARN, PingEntries::Pi4_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::Pi4_rateGroup3::WARN, PingEntries::Pi4_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology() {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(Pi4PacketsPkts, Pi4PacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name Pi4
namespace Pi4 {
void setupTopology(const TopologyState& state) {
    ...
    if (state.hostname != nullptr && state.port != 0) {
     ...
     bool uart_open = roombaDriver.open("/dev/ttyS0",
