// ======================================================================
// \title  Pi4Topology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef PI4_PI4TOPOLOGY_HPP
#define PI4_PI4TOPOLOGY_HPP
// Included for access to Pi4::TopologyState and Pi4::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Pi4/Top/Pi4TopologyDefs.hpp>

// Remove unnecessary Pi4:: qualifications
using namespace Pi4;
namespace Pi4 {
/**
 ...
 * Pi4::TopologyState see: Pi4TopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Pi4::TopologyState see: Pi4TopologyDefs.hpp.
 *
