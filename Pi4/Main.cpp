...
#include <Pi4/Top/Pi4Topology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    Pi4::setupTopology(inputs);
    Pi4::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Pi4::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
